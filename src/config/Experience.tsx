...
export const experiences: Experience[] = [
  ...
  {
    isCurrent: false,
    company: 'Amika Software',
    position: 'Junior Developer',
    location: 'Nagpur, India (On-Site)',
    image: '/company/upsurge.png',
    description: [
      'Contributed to backend and frontend development of scalable web applications using the MERN stack, with a focus on performance, reliability, and clean architecture.',
      'Designed, developed, and deployed core application features, improving usability, responsiveness, and overall user experience.',
      'Implemented and tested RESTful APIs, authentication flows, and database operations to ensure secure and stable system behavior.',
      'Optimized development workflows by maintaining reusable components, improving internal tools, and documenting technical processes for better team collaboration.',
    ],
    startDate: 'July 2025',
    endDate: 'Present',
    technologies: [
